  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setTimeout(() => {
        ...
        window.open(`https://wa.me/233650985980?text=${whatsappMessage}`, '_blank');
      }, 2000);
            ...
            <CardContent>
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <Button
                  ...
                  className="w-full bg-shield-gold hover:bg-shield-gold/90 text-shield-dark py-3 font-semibold neon-glow-gold hover-lift"
                >
            ...
            <Card className="bg-gradient-to-br from-shield-green/10 to-transparent border-shield-green/30 neon-glow-green hover-lift">
              ...
              <CardContent>
                <div className="flex items-center justify-between mb-6">
                  <div>
                    <p className="text-shield-green font-semibold text-lg">+233 650 985 980</p>
                ...
                >
                  <a
                    href="https://wa.me/233650985980?text=Hi%20ShieldNest,%20I'm%20interested%20in%20your%20cybersecurity%20services"
                    target="_blank"
